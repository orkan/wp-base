...
return Data},spinner(id,show=!0,className='is-active'){if(id){const ClassList=document.querySelector(id).classList;show?ClassList.add(className):ClassList.remove(className)}},};$(function(){})})(jQuery)